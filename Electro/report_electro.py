...
filename = 'ЭЭ_' + month_txt + '_' + str(year_txt) + '.xlsx'
...
def send_email(addr_to, msg_subj, msg_text, files):
    ...
    server = smtplib.SMTP('mail.tm-ankovo.ru', 587)
...
addr_to = "sa@tm-ankovo.ru"  # Получатель
files = ['./' + filename]  # Если нужно отправить все файлы из заданной папки, нужно указать её

send_email(addr_to, 'Отчет по электроэнергии за ' + month_txt + ' ' + str(year_txt),
           'Отчет по электроэнергии за ' + month_txt + ' ' + str(year_txt), files)
