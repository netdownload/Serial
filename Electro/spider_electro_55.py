...
# В ответе проверить байт состояния, возможно он отвечает за то какой банк памяти брать
DELAY = 0.2
...
def log_setup():
    log_handler = logging.handlers.WatchedFileHandler('spider_electro_55.txt')
